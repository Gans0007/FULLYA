...
PROFILE_FSM_TEXTS = {
    "ru": {
        ...
        "prompts": {
            ...
            "specialization": "🧠 Укажи новую специализацию (не больше 15 символов):",
            "help": "💡 Чем ты можешь быть полезен другим? (не больше 70 символов)",
            "message": "🤝 Добавь свою социальную сеть (не больше 30 символов):",
        },
        "cancel": "❌ Отмена",
        ...
        "errors": {
            ...
            "help": "❌ Описание пользы не должно превышать 70 символов.",
            "message": "❌ Послание или соц.сеть не должны быть длиннее 30 символов.",
        },
        "view_changes": "👀 Просмотреть изменения",
        "updated": "✅ Обновлено, просмотреть можно нажав на кнопку ниже!",
        "step_age": "🎂 Введи возраст:",
        "step_spec": "🧠 Напиши свою специализацию (не больше 15 символов):",
        "step_help": "💡 Чем ты можешь быть полезен другим? (не больше 70 символов):",
        "step_message": "🤝 Добавь свою социальную сеть (не больше 30 символов):",
    ...
    "uk": {
        ...
        "prompts": {
            ...
            "age": "🎂 Введи новий вік:",
            "specialization": "🧠 Вкажи нову спеціалізацію (не більше 15 символів):",
            "help": "💡 Чим ти можеш бути корисним іншим? (не більше 70 символів)",
            "message": "🤝 Додай свою соціальну мережу (не більше 30 символів):",
        },
        "cancel": "❌ Скасувати",
        "cancelled": "❌ Скасовано. Повертаю до профілю.",
        "errors": {
            "age": "❌ Вік має бути числом. Спробуй ще раз.",
            "specialization": "❌ Спеціалізація має бути не довше 15 символів.",
            "help": "❌ Опис користі не має перевищувати 70 символів.",
            "message": "❌ Послання або соц.мережа не мають бути довші за 30 символів.",
        },
        "view_changes": "👀 Переглянути зміни",
        "updated": "✅ Оновлено, переглянути можна натиснувши на кнопку нижче!",
        "step_age": "🎂 Введи вік:",
        "step_spec": "🧠 Напиши свою спеціалізацію (не більше 15 символів):",
        "step_help": "💡 Чим ти можеш бути корисним іншим? (не більше 70 символів):",
        "step_message": "🤝 Додай свою соціальну мережу (не більше 30 символів):",
    ...
    "en": {
        ...
        "prompts": {
            "name": "👤 Enter new name:",
            "age": "🎂 Enter new age:",
            "specialization": "🧠 Enter new specialization (max 15 chars):",
            "help": "💡 How can you be useful to others? (max 70 chars)",
            "message": "🤝 Add your social network (max 30 chars):",
        },
        "cancel": "❌ Cancel",
        "cancelled": "❌ Cancelled. Returning to profile.",
        "errors": {
            "age": "❌ Age must be a number. Try again.",
            "specialization": "❌ Specialization must be 15 chars or less.",
            "help": "❌ Help description must be 70 chars or less.",
            "message": "❌ Message or social must be 30 chars or less.",
        },
        "view_changes": "👀 View changes",
        "updated": "✅ Updated, you can view it by pressing the button below!",
        "step_age": "🎂 Enter age:",
        "step_spec": "🧠 Enter your specialization (max 15 chars):",
        "step_help": "💡 How can you be useful to others? (max 70 chars):",
        "step_message": "🤝 Add your social network (max 30 chars):",
